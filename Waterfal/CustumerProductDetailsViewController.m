//
//  CustumerProductDetailsViewController.m
//  Waterfal
//
...
@interface CustumerProductDetailsViewController ()<UITextFieldDelegate>{
NSString * p_id;
...
@implementation CustumerProductDetailsViewController
...
-(void)getData
{
    ...
    dispatch_queue_t queue = dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0ul);
          dispatch_async(queue, ^{
              ...
              NSString *Url = [NSString stringWithFormat:@"%@%@?id=%@&user_id=%@&v=%d", BASEURL, PRODUCT, self->p_id, self->user_id, ver];
...
- (void)collectionView:(UICollectionView *)cv didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
         ...
         CustumerProductDetailsViewController *go = [self.storyboard instantiateViewControllerWithIdentifier:@"productDetails"];
